  ...
  return (
    <div className="form">
      ...
      <div className='Register-container'>
         ...
         <div className="Register-content-left__heading">HELPING HANDS<FontAwesomeIcon icon={faHandHoldingHeart} className="Register-website__logo"/></div>
         <div className="Register-content-left__subHeading">
      Become a part of the helping hands community and stay updated to all the schemes you can take advantage of  </div> </div>
        {!isSubmitted ? (
